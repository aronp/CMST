...
This window is an implementation of **CMST (Cosh Momment Sturm Transform)**. Unlike standard windows which are often heuristic curve-fits, the Hyper-CMST window is constructed as a **Geometric Mollifier** with three rigorous guarantees:
...
*(Place your comparison image here, e.g., `![Jerk Comparison](examples/jerk_comparison.png)`)*

### 📦 Installation

```bash
git clone [https://github.com/aronp/CMST.git](https://github.com/aronp/cmst-window.git)
