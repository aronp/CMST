...
\begin{equation}
    \boxed{ N \ge \frac{f_s}{\Delta f} \cdot \frac{\left(\ln(R)\right)^2 }{\pi}}
\end{equation}
...
\noindent \textbf{4. Practical Rule:} To resolve a weak signal against a contrast ratio $R$, you must observe long enough that the signal shifts at least $[\ln(R)]^2$ bins away from the interferer.
\begin{itemize}
...
\begin{itemize}
    \item \textbf{Setup:} A "Sun" (Radius $15\,\text{px}$) and two "Planets" (Radius $50\,\text{px}$) on a $2048 \times 2048$ grid.
