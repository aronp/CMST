...
\begin{document}
\title{The bilateral Laplace Transform of Even Log-concave functions having zeros on the Imaginary axis}
...
with convex $f(t)$ have all distinct zeros on the imaginary axis. The CMST 
...
\begin{equation}
    \frac{1}{t^{2k}-1} = -\sum_{n=0}^{\infty} t^{2nk} = -(1 + t^{2k} + t^{4 k} + \dots)
\end{equation}
