...
\subsection{Numerical Verification: The "Planet Test"}
To verify the resolution law in a 2D imaging context, we simulated a high-contrast stellar observation.
\begin{itemize}
    \item \textbf{Setup:} A "Sun" (Radius $15\,\text{px}$) and two "Planets" (Radius $50\,\text{px}$) on a $2048 \times 2048$ grid.
    \item \textbf{Contrast:} The planets were set to $-80\,\text{dB}$ ($10^{-4}$) relative to the Sun.
...
\noindent \textbf{Prediction:} According to the CMST Resolution Law for $R=10^4$ ($80\,\text{dB}$), the required separation is:
\begin{equation}
