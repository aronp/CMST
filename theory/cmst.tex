...
\begin{remark}[$\mu_{0}$ is still a mystery]
Well we know its value, $\sim 0.443994$ and given that we have found a relationship between all the subsequent moments, it would be nice to have an expression for $\mu_{0}$
\end{remark}
