...
\begin{equation}
F(s) = \cos (s) (-\text{Ci}((1-a) s)+\text{Ci}((a+1) s)+c_1)+\sin (s)
   (\text{Si}((a-1) s)+\text{Si}((a+1) s)+c_2)
\end{equation}
Noting that the function is even and equating coefficients gives us $c_1 =0$, $c_2 =0$ which gives us our result
\end{proof}
