...
\begin{equation}
    \boxed{ N \ge \frac{f_s}{\Delta f} \cdot \left(\ln(R)\right)^2 }
\end{equation}
...
\begin{equation}
    \underbrace{T \cdot f_s}_{\text{Total Samples } N} \quad \times \quad \underbrace{\left( \frac{\Delta f}{f_s} \right)}_{\text{Closeness Ratio } \rho} \quad \ge \quad \underbrace{\left[ \ln(R) \right]^2}_{\text{Contrast Cost}}
\end{equation}
...
\begin{equation}
    R \le \exp\left( \sqrt{N \cdot \rho} \right)
\end{equation}
