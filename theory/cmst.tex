...
\end{equation}
\textbf{Conclusion:} On the imaginary axis, the linear growth term $i\omega$ becomes purely distinct phase oscillation, leaving the $\sqrt{\omega}$ term to enforce \textbf{Gevrey-class decay}.

\begin{remark}
We can do similar analysis from functions of the form
\begin{equation}
