...
\begin{theorem}[$ \int_{-1}^{1} \exp\left( \frac{1}{t^{2k}-1} \right)cos(st), dt  =-\text{Si}(2 s) \sin (s) * \int_{-1}^{1} \exp\left( \frac{1}{t^{2k}-1} \right)cos(st), dt $]
\end{theorem}
\begin{proof}
Let
\begin{equation}
...
\begin{equation}
\imath s W(s) = -\imath \, s \, \text{Si}(2 s) \sin (s) \ast W(s)
\end{equation}
where $\ast$ is convolution 
or
\begin{equation}
W(s) = -\text{Si}(2 s) \sin (s) \ast W(s)
\end{equation}
\end{proof}
