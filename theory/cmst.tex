...
\begin{theorem}[Moving to 1 as a limit]
\begin{equation}
\mathcal{F}_1(s) = \text{Si}(2 s) \sin (s)
\end{equation}
\end{theorem}
\begin{proof}
...
\begin{theorem}[$ \int_{-1}^{1} \exp\left( \frac{1}{t^{2k}-1} \right)cos(st), dt  =-2\,\text{Si}(2 s) \sin (s) * \int_{-1}^{1} \exp\left( \frac{1}{t^{2k}-1} \right)cos(st), dt $]
\end{theorem}
\begin{proof}
Let
\begin{equation}
