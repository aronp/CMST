...
\[
4 s F''(s)+2 F'(s) \text{ or }  D(4sD + 2) = \mathcal{T}_{\text{rad}}
\]
...
\end{theorem}
\begin{proof}
That is simply the result of applying $sD$ to the transform, and moving the $t^2$ terms outside to their $\mathcal{T}_{\text{rad}}$ equivalents.
\end{proof}
\begin{remark}
When $f(t)$ is not a regular power of t, its possible this term may introduce some drift in the interlacing patterns
\end{remark}
