...
In high-dynamic-range applications—such as gravitational wave detection \cite{LIGO} or 32-bit audio synthesis—the limiting factor is often not the main-lobe width (resolution), but the side-lobe decay rate (spectral leakage).
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=\columnwidth]{../proofs/VsOtherFilters.pdf}
